    ...
    <div class="w-full h-full leading-loose">
        <form class="w-11/12 m-4 p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('vendor.add-dish') }}" enctype="multipart/form-data">
            ...
            <div class="">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="dish_name" name="dish_name" type="text" required placeholder="Name" aria-label="Dish Name">
            </div>
            <div class="mt-2">
                <label class="block text-sm text-gray-600" for="ingredients">Ingredients</label>
                <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="ingredients" name="ingredients" type="text" required placeholder="Eggs,bacon,..." aria-label="Ingredients">
            </div>
            <div class="mt-2">
                <label class="block text-sm text-gray-600" for="price">Price (KES)</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="price" name="price" type="text" required placeholder="850" aria-label="Price">
            </div>
            <div class="mt-2">
                <main class="border-2 border-gray-300 rounded-md h-auto">
                    <!-- file upload modal -->
