...
<body 
  class="leading-normal tracking-normal text-white gradient smooth-scroll" 
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      ...
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="mr-3">
            <a class="inline-block py-2 px-4 text-black no-underline" href="#home">Home</a>
          </li>
          <li class="mr-3">
          ...
          <li class="mr-3">
            <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#discover">Discover</a>
          </li>
          @auth
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="{{ route('profile.show') }}">{{ auth()->user()->name }}</a>
            </li>
          @endauth
        </ul>
        @auth
      ...
      <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
        <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
          <a href="#" class="flex flex-wrap no-underline hover:no-underline">
            ...
            <div class="w-full font-bold text-xl text-gray-800 px-6">
              Experience the ultimate urban living experience
            </div>
            <p class="text-gray-800 text-base px-6 mb-5">
              Leverage technology to ensure you reap the maximum benefits of urban living in this concrete jungle.
            </p>
          </a>
        </div>
        <!-- <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
  ...
  <section id="discover" class="container mx-auto text-center py-6 mb-12">
